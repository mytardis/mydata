...
Previous Version
^^^^^^^^^^^^^^^^
* Download MyData for Windows: `MyData_v0.5.2.exe <https://github.com/mytardis/mydata/releases/download/v0.5.2/MyData_v0.5.2.exe>`_
* Download MyData for Mac OS X: `MyData_v0.5.2.dmg <https://github.com/mytardis/mydata/releases/download/v0.5.2/MyData_v0.5.2.dmg>`_
