...
This was used by the SCP upload test in Python 2.
But that test isn't yet working in Python 3
and neither is this module.  It is not clear if
it is worth fixing or whether SCP will soon be replace by SFTP.
